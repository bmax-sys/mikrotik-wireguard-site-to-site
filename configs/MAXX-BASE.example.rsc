...
#
# Replace <REMOTE_PUBLIC_KEY> with the REMOTE WireGuard public key.
...
add allowed-address=10.66.66.2/32,192.168.89.0/24 \
    interface=wg-site-to-site name=remote-peer \
    public-key="<REMOTE_PUBLIC_KEY>" responder=yes

/ip address
add address=192.168.88.1/24 interface=bridge-LAN network=192.168.88.0
add address=10.66.66.1/24 interface=wg-site-to-site network=10.66.66.0
